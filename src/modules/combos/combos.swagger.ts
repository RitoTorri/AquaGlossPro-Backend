...
export function ApiCreateComboDoc() {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Crea un nuevo combo en el sistema. Si es promoción, la fecha de expiración es obligatoria y debe ser futura.',
        }),
...
export function ApiFindAllCombosDoc() {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Obtiene la lista de combos activos. Los combos promocionales expirados se desactivan automáticamente.',
        }),
